...
import { X, BookOpen, CheckCircle2, Cpu, ShieldCheck, FileText, Layers } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-slate-900 border border-slate-700 rounded-xl w-full max-w-3xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-xs text-slate-300">
          <div className="bg-slate-950/80 p-4 rounded-lg border border-slate-800 leading-relaxed">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-3 bg-slate-800/60 rounded border border-slate-700/60 space-y-1">
                <div className="font-bold text-white">Rule R1: 80% UC Pre-Release Rule</div>
                <div className="text-[11px] text-amber-400 font-mono">Para 4.3 Guidelines</div>
              ...
              <div className="p-3 bg-slate-800/60 rounded border border-slate-700/60 space-y-1">
                <div className="font-bold text-white">Rule R2: Trust / Society ₹50L Cap</div>
                <div className="text-[11px] text-amber-400 font-mono">Para 3.14 Guidelines</div>
                <p className="text-[11px] text-slate-400">
              ...
              <div className="p-3 bg-slate-800/60 rounded border border-slate-700/60 space-y-1">
                <div className="font-bold text-white">Rule R3: Outside Constituency ₹25L Cap</div>
                <div className="text-[11px] text-amber-400 font-mono">Para 3.12 Guidelines</div>
                <p className="text-[11px] text-slate-400">
              ...
              <div className="p-3 bg-slate-800/60 rounded border border-slate-700/60 space-y-1">
                <div className="font-bold text-white">Rule R4: Annexure-VIII Category NLP</div>
                <div className="text-[11px] text-amber-400 font-mono">Annexure-VIII Mandate</div>
                <p className="text-[11px] text-slate-400">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="p-3 bg-slate-800/60 rounded border border-slate-700/60">
                <span className="font-bold text-white">Isolation Forest Overrun Outlier Detector: </span>
              ...
              <div className="p-3 bg-slate-800/60 rounded border border-slate-700/60">
                <span className="font-bold text-white">TF-IDF + Haversine Duplicate Work Clustering: </span>
                <span className="text-slate-300">
                  Calculates lexical similarity matrix on work descriptions ($cos(\theta) &gt; 0.65$) combined with spatial proximity ($&lt; 800$ meters) to catch split contracts and duplicate billing.
                </span>
              </div>

              <div className="p-3 bg-slate-800/60 rounded border border-slate-700/60">
                <span className="font-bold text-white">Herfindahl-Hirschman Agency Concentration Index (HHI): </span>
                <span className="text-slate-300">
                  $HHI = \sum (s_i)^2$. Flags disproportionate single-agency allocation ($&gt; 45\%$ of an MP's fund) to ensure competitive procurement.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-950 p-4 rounded-lg border border-slate-800 space-y-1">
            <div className="font-bold text-slate-100 text-xs">Composite Risk Score Formulation:</div>
